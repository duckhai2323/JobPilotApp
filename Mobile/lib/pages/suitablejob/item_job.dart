...
class JobSuitItem extends GetView<SuitableController> {
  ...
  JobSuitItem (this.context, this.companyImage, this.companyName, this.jobTitle, this.jobLocation, this.experienceRequire,this.salary,this.isSaved,this.index);
  @override
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(onTap:(){
                controller.updateSaveJob(index);
