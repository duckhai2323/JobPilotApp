...
class JobSaveItem extends GetView<JobSavedController> {
  ...
  JobSaveItem (this.context, this.companyImage, this.companyName, this.jobTitle, this.jobLocation, this.experienceRequire,this.salary,this.isSaved,this.index);
  @override
        ...
        children: [
          Row(
            ...
            children: [
              ...
              InkWell(onTap:(){
                controller.deleteSaveJob(index);
              },child: Icon(isSaved?Icons.bookmark_outlined:Icons.bookmark_outline_rounded, color: isSaved?AppColors.primaryColor1:AppColors.placeHolderColor,size: 30,)),
            ],
          ),
