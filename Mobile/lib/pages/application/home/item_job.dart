...
class JobItemHome extends GetView<HomeController> {
  ...
  JobItemHome (this.context, this.companyImage, this.companyName, this.jobTitle, this.jobLocation, this.experienceRequire,this.salary,this.isSaved,this.index);
  @override
