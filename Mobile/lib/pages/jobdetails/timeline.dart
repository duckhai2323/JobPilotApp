...
class TimeLineInterviewCandiateRole extends GetView<JobDetailsController> {
  final bool isFirst;
  final bool isLast;
  final bool isPast;
  final String title;
  final String date;
  final int index;
  TimeLineInterviewCandiateRole(this.isFirst,this.isLast,this.isPast,this.title,this.date,this.index);
  @override
