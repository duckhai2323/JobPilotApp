class Company {
  ...
  Company(this.company_name, this.email, this.employee_scale, this.company_intro,this.company_link, this.company_image, this.company_location, this.company_filed,this.status,{this.company_id});
