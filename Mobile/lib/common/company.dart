class Company {
  ...
  Company(this.company_name, this.email, this.employee_scale, this.company_intro,this.company_link,this.company_location, this.company_filed,this.company_organize,{this.company_id,this.status,this.company_image});
  ...
  factory Company.fromJson(dynamic json) {
    return Company(
        ...
        company_image:json['company_image'] as String,
