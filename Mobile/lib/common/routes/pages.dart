...
import '../../pages/application/candidate/cv_manage/cv_manage_binding.dart';
import '../../pages/application/candidate/cv_manage/cv_manage_view.dart';
import '../../pages/candidate/applyjob/apply_job.binding.dart';
import '../../pages/candidate/applyjob/apply_job_view.dart';
import '../../pages/candidate/companies/companies_binding.dart';
import '../../pages/candidate/companies/companies_view.dart';
import '../../pages/candidate/jobapplied/jobapplied_binding.dart';
import '../../pages/candidate/jobapplied/jobapplied_view.dart';
import '../../pages/candidate/jobdetails/jobdetails_binding.dart';
import '../../pages/candidate/jobdetails/jobdetails_view.dart';
import '../../pages/candidate/jobsaved/jobsaved_binding.dart';
import '../../pages/candidate/jobsaved/jobsaved_view.dart';
import '../../pages/candidate/suitablejob/suitablejob_binding.dart';
import '../../pages/candidate/suitablejob/suitablejob_view.dart';
import '../../pages/candidate/topcv_profile_page/topcv_profile_binding.dart';
import '../../pages/candidate/topcv_profile_page/topcv_profile_view.dart';
